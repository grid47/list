...
---
{{< youtube n6Wg_vntUAA >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2734: Lexicographically Smallest String After Substring Operation](https://grid47.xyz/posts/leetcode-2734-lexicographically-smallest-string-after-substring-operation-solution/) |
| --- |
{{< notice tip >}}
