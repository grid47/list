...
---
{{< youtube 3psLUZqiGx0 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1541: Minimum Insertions to Balance a Parentheses String](https://grid47.xyz/posts/leetcode-1541-minimum-insertions-to-balance-a-parentheses-string-solution/) |
| --- |
{{< notice tip >}}
