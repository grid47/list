...
---
{{< youtube 3psLUZqiGx0 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1541: Minimum Insertions to Balance a Parentheses String](https://grid47.xyz/posts/leetcode-1541-minimum-insertions-to-balance-a-parentheses-string-solution/) |
| --- |
{{< notice info >}}
