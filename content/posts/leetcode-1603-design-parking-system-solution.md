...
---
{{< youtube d5zCHesOrSk >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1604: Alert Using Same Key-Card Three or More Times in a One Hour Period](https://grid47.xyz/posts/leetcode-1604-alert-using-same-key-card-three-or-more-times-in-a-one-hour-period-solution/) |
| --- |
{{< notice tip >}}
