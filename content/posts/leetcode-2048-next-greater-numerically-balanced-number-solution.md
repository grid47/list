...
---
{{< youtube VLLBGEWCHqs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2049: Count Nodes With the Highest Score](https://grid47.xyz/posts/leetcode-2048-next-greater-numerically-balanced-number-solution/) |
| --- |
{{< notice info >}}
