...
---
{{< youtube -sU51QkOwLY >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #3137: Minimum Number of Operations to Make Word K-Periodic](https://grid47.xyz/posts/leetcode-3137-minimum-number-of-operations-to-make-word-k-periodic-solution/) |
| --- |
{{< notice info >}}
