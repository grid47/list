...
---
{{< youtube rOnTeyl_njo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2328: Number of Increasing Paths in a Grid](https://grid47.xyz/posts/leetcode-2328-number-of-increasing-paths-in-a-grid-solution/) |
| --- |
{{< notice tip >}}
