...
---
{{< youtube EcvhHoFaDoU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1489: Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree](https://grid47.xyz/posts/leetcode-1489-find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree-solution/) |
| --- |
{{< notice tip >}}
