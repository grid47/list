...
---
{{< youtube ovFs2xad0_Y >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2654: Minimum Number of Operations to Make All Array Elements Equal to 1](https://grid47.xyz/posts/leetcode-2654-minimum-number-of-operations-to-make-all-array-elements-equal-to-1-solution/) |
| --- |
{{< notice tip >}}
