...
---
{{< youtube GcgV-AtAmkg >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2829: Determine the Minimum Sum of a k-avoiding Array](https://grid47.xyz/posts/leetcode-2828-check-if-a-string-is-an-acronym-of-words-solution/) |
| --- |
{{< notice info >}}
