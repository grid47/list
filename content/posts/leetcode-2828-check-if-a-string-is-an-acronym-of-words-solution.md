...
---
{{< youtube GcgV-AtAmkg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2829: Determine the Minimum Sum of a k-avoiding Array](https://grid47.xyz/posts/leetcode-2829-determine-the-minimum-sum-of-a-k-avoiding-array-solution/) |
| --- |
{{< notice tip >}}
