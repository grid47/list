...
---
{{< youtube d4SPuvkaeoo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1247: Minimum Swaps to Make Strings Equal](https://grid47.xyz/posts/leetcode-1247-minimum-swaps-to-make-strings-equal-solution/) |
| --- |
{{< notice tip >}}
