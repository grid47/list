...
---
{{< youtube geZPsJWEzfc >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Udemy Course](https://grid47.xyz/courses/) / Next : [LeetCode #1110: Delete Nodes And Return Forest](https://grid47.xyz/posts/leetcode-1110-delete-nodes-and-return-forest-solution/) |
| --- |
