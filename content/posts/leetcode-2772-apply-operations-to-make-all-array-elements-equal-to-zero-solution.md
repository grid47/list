...
---
{{< youtube xpjC9rt9xsM >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2778: Sum of Squares of Special Elements ](https://grid47.xyz/posts/leetcode-2772-apply-operations-to-make-all-array-elements-equal-to-zero-solution/) |
| --- |
{{< notice info >}}
