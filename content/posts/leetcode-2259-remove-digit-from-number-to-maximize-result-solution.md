...
---
{{< youtube cinEIxOL0E8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2260: Minimum Consecutive Cards to Pick Up](https://grid47.xyz/posts/leetcode-2259-remove-digit-from-number-to-maximize-result-solution/) |
| --- |
{{< notice info >}}
