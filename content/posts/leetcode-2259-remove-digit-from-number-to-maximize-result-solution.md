...
---
{{< youtube cinEIxOL0E8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2260: Minimum Consecutive Cards to Pick Up](https://grid47.xyz/posts/leetcode-2260-minimum-consecutive-cards-to-pick-up-solution/) |
| --- |
{{< notice info >}}
