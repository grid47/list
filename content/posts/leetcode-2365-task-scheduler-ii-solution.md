...
---
{{< youtube iuiNCc0HkX8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2366: Minimum Replacements to Sort the Array](https://grid47.xyz/posts/leetcode-2366-minimum-replacements-to-sort-the-array-solution/) |
| --- |
{{< notice tip >}}
