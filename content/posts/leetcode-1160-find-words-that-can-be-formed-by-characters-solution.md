...
---
{{< youtube riRpJLMdrXs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1161: Maximum Level Sum of a Binary Tree](https://grid47.xyz/posts/leetcode-1161-maximum-level-sum-of-a-binary-tree-solution/) |
| --- |
{{< notice info >}}
