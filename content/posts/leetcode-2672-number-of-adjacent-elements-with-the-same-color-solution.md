...
---
{{< youtube w3L3-aRiNXE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2673: Make Costs of Paths Equal in a Binary Tree](https://grid47.xyz/posts/leetcode-2673-make-costs-of-paths-equal-in-a-binary-tree-solution/) |
| --- |
{{< notice tip >}}
