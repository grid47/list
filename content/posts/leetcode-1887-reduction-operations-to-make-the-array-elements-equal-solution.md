...
---
{{< youtube 1etc9Ip8Xm8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1888: Minimum Number of Flips to Make the Binary String Alternating](https://grid47.xyz/posts/leetcode-1888-minimum-number-of-flips-to-make-the-binary-string-alternating-solution/) |
| --- |
{{< notice tip >}}
