...
---
{{< youtube _tfiTQNZCbs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1233: Remove Sub-Folders from the Filesystem](https://grid47.xyz/posts/leetcode-1233-remove-sub-folders-from-the-filesystem-solution/) |
| --- |
{{< notice tip >}}
