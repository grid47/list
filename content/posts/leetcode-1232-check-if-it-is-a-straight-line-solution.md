...
---
{{< youtube _tfiTQNZCbs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1233: Remove Sub-Folders from the Filesystem](https://grid47.xyz/posts/leetcode-1232-check-if-it-is-a-straight-line-solution/) |
| --- |
{{< notice info >}}
