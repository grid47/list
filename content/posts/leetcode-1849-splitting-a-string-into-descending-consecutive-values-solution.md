...
---
{{< youtube eDtMmysldaw >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1850: Minimum Adjacent Swaps to Reach the Kth Smallest Number](https://grid47.xyz/posts/leetcode-1849-splitting-a-string-into-descending-consecutive-values-solution/) |
| --- |
{{< notice info >}}
