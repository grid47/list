...
---
{{< youtube 1wXkWZtSD28 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2800: Shortest String That Contains Three Strings](https://grid47.xyz/posts/leetcode-2800-shortest-string-that-contains-three-strings-solution/) |
| --- |
{{< notice tip >}}
