...
---
{{< youtube LdM0WLfhF_4 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2267:  Check if There Is a Valid Parentheses String Path](https://grid47.xyz/posts/leetcode-2267-check-if-there-is-a-valid-parentheses-string-path-solution/) |
| --- |
{{< notice tip >}}
