...
---
{{< youtube xAPYdvSkcF8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1448: Count Good Nodes in Binary Tree](https://grid47.xyz/posts/leetcode-1448-count-good-nodes-in-binary-tree-solution/) |
| --- |
{{< notice info >}}
