...
---
{{< youtube ejBwc2oE7ck >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1663: Smallest String With A Given Numeric Value](https://grid47.xyz/posts/leetcode-1663-smallest-string-with-a-given-numeric-value-solution/) |
| --- |
{{< notice tip >}}
