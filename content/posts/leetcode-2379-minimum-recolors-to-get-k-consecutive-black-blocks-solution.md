...
---
{{< youtube RRmSKRsT9tg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2380: Time Needed to Rearrange a Binary String](https://grid47.xyz/posts/leetcode-2380-time-needed-to-rearrange-a-binary-string-solution/) |
| --- |
{{< notice tip >}}
