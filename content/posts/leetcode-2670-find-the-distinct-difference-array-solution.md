...
---
{{< youtube ikDNBcVaq6Y >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2672: Number of Adjacent Elements With the Same Color](https://grid47.xyz/posts/leetcode-2672-number-of-adjacent-elements-with-the-same-color-solution/) |
| --- |
{{< notice tip >}}
