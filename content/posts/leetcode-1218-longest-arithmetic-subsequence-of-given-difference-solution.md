...
---
{{< youtube NpQ-ZKBNCa8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1219: Path with Maximum Gold](https://grid47.xyz/posts/leetcode-1219-path-with-maximum-gold-solution/) |
| --- |
{{< notice info >}}
