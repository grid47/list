...
---
{{< youtube yTpRd3yvyz0 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2516: Take K of Each Character From Left and Right](https://grid47.xyz/posts/leetcode-2515-shortest-distance-to-target-string-in-a-circular-array-solution/) |
| --- |
{{< notice info >}}
