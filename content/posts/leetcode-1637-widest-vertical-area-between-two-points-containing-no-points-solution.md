...
---
{{< youtube 6XnvNCTyJP4 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1638: Count Substrings That Differ by One Character](https://grid47.xyz/posts/leetcode-1638-count-substrings-that-differ-by-one-character-solution/) |
| --- |
{{< notice tip >}}
