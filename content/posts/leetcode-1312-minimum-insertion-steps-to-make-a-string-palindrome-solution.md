...
---
{{< youtube ggQlIW5keAA >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1314: Matrix Block Sum](https://grid47.xyz/posts/leetcode-1312-minimum-insertion-steps-to-make-a-string-palindrome-solution/) |
| --- |
{{< notice info >}}
