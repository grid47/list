...
---
{{< youtube 9wZ-TWBreTg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1718: Construct the Lexicographically Largest Valid Sequence](https://grid47.xyz/posts/leetcode-1718-construct-the-lexicographically-largest-valid-sequence-solution/) |
| --- |
