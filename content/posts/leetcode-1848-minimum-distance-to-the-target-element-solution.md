...
---
{{< youtube eAA1gS_2QwY >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1849: Splitting a String Into Descending Consecutive Values](https://grid47.xyz/posts/leetcode-1849-splitting-a-string-into-descending-consecutive-values-solution/) |
| --- |
{{< notice tip >}}
