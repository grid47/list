...
---
{{< youtube 0l2IwK_OHac >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2919: Minimum Increment Operations to Make Array Beautiful](https://grid47.xyz/posts/leetcode-2919-minimum-increment-operations-to-make-array-beautiful-solution/) |
| --- |
{{< notice tip >}}
