...
---
{{< youtube vcrOpJQHsSE >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2265: Count Nodes Equal to Average of Subtree](https://grid47.xyz/posts/leetcode-2264-largest-3-same-digit-number-in-string-solution/) |
| --- |
{{< notice info >}}
