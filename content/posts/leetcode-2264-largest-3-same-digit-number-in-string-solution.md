...
---
{{< youtube vcrOpJQHsSE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2265: Count Nodes Equal to Average of Subtree](https://grid47.xyz/posts/leetcode-2265-count-nodes-equal-to-average-of-subtree-solution/) |
| --- |
{{< notice tip >}}
