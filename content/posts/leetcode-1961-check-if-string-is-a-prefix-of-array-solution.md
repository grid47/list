...
---
{{< youtube msS6F5DL8gQ >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1962: Remove Stones to Minimize the Total](https://grid47.xyz/posts/leetcode-1962-remove-stones-to-minimize-the-total-solution/) |
| --- |
{{< notice tip >}}
