...
---
{{< youtube msS6F5DL8gQ >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1962: Remove Stones to Minimize the Total](https://grid47.xyz/posts/leetcode-1961-check-if-string-is-a-prefix-of-array-solution/) |
| --- |
{{< notice info >}}
