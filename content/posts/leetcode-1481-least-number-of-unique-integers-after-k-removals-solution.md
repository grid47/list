...
---
{{< youtube Nsp_ta7SlEk >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1482: Minimum Number of Days to Make m Bouquets](https://grid47.xyz/posts/leetcode-1482-minimum-number-of-days-to-make-m-bouquets-solution/) |
| --- |
