...
---
{{< youtube knLFe7hEp3Y >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1974: Minimum Time to Type Word Using Special Typewriter](https://grid47.xyz/posts/leetcode-1974-minimum-time-to-type-word-using-special-typewriter-solution/) |
| --- |
{{< notice info >}}
