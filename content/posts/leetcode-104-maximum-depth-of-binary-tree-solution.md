...
---
{{< youtube ScvTcU2Aifs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #105: Construct Binary Tree from Preorder and Inorder Traversal](https://grid47.xyz/posts/leetcode-105-construct-binary-tree-from-preorder-and-inorder-traversal-solution/) |
| --- |
{{< notice tip >}}
