...
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #988: Smallest String Starting From Leaf](https://grid47.xyz/posts/leetcode-988-smallest-string-starting-from-leaf-solution/) |
| --- |
{{< notice info >}}
