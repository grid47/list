...
---
{{< youtube K-IoQp07D8c >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2222: Number of Ways to Select Buildings](https://grid47.xyz/posts/leetcode-2222-number-of-ways-to-select-buildings-solution/) |
| --- |
{{< notice tip >}}
