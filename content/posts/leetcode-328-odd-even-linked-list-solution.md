...
---
{{< youtube HaoudL9xEHA >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #329: Longest Increasing Path in a Matrix](https://grid47.xyz/posts/leetcode-329-longest-increasing-path-in-a-matrix-solution/) |
| --- |
{{< notice tip >}}
