...
---
{{< youtube ZH8TeWFYpx8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1261: Find Elements in a Contaminated Binary Tree](https://grid47.xyz/posts/leetcode-1261-find-elements-in-a-contaminated-binary-tree-solution/) |
| --- |
{{< notice tip >}}
