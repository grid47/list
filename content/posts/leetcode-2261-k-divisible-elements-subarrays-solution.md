...
---
{{< youtube BZdbRvIM-js >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2264: Largest 3-Same-Digit Number in String](https://grid47.xyz/posts/leetcode-2264-largest-3-same-digit-number-in-string-solution/) |
| --- |
{{< notice info >}}
