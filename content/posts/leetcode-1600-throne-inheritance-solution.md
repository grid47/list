...
---
{{< youtube VId-YNg9IG0 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1601: Maximum Number of Achievable Transfer Requests](https://grid47.xyz/posts/leetcode-1601-maximum-number-of-achievable-transfer-requests-solution/) |
| --- |
{{< notice tip >}}
