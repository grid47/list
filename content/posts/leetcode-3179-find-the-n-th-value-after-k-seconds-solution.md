...
---
{{< youtube 4sO18TX7Qzw >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #3190: Find Minimum Operations to Make All Elements Divisible by Three](https://grid47.xyz/posts/leetcode-3190-find-minimum-operations-to-make-all-elements-divisible-by-three-solution/) |
| --- |
{{< notice tip >}}
