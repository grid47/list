...
---
{{< youtube vyXBp3S6-y4 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1320: Minimum Distance to Type a Word Using Two Fingers](https://grid47.xyz/posts/leetcode_1320) |
| --- |
{{< notice info >}}
