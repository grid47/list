...
---
{{< youtube QEESBA2Q_88 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1003: Check If Word Is Valid After Substitutions](https://grid47.xyz/posts/leetcode-1003-check-if-word-is-valid-after-substitutions-solution/) |
| --- |
{{< notice tip >}}
