...
---
{{< youtube g1R3yEtHT8E >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #865: Smallest Subtree with all the Deepest Nodes](https://grid47.xyz/posts/leetcode-865-smallest-subtree-with-all-the-deepest-nodes-solution/) |
| --- |
{{< notice tip >}}
