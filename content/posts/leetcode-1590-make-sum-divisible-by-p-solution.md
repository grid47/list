...
---
{{< youtube tZXsLAyE0SE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1593: Split a String Into the Max Number of Unique Substrings](https://grid47.xyz/posts/leetcode-1593-split-a-string-into-the-max-number-of-unique-substrings-solution/) |
| --- |
{{< notice tip >}}
