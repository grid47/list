...
---
{{< youtube vJ7ZWmfO1Rw >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2543: Check if Point Is Reachable](https://grid47.xyz/posts/leetcode-2543-check-if-point-is-reachable-solution/) |
| --- |
{{< notice tip >}}
