...
---
{{< youtube DEMUS-1tq-0 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1975: Maximum Matrix Sum](https://grid47.xyz/posts/leetcode-1974-minimum-time-to-type-word-using-special-typewriter-solution/) |
| --- |
{{< notice info >}}
