...
---
{{< youtube IDTzmXD5H58 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1827: Minimum Operations to Make the Array Increasing](https://grid47.xyz/posts/leetcode-1827-minimum-operations-to-make-the-array-increasing-solution/) |
| --- |
