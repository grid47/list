...
---
{{< youtube koGHcwtIaLY >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1466: Reorder Routes to Make All Paths Lead to the City Zero](https://grid47.xyz/posts/leetcode-1466-reorder-routes-to-make-all-paths-lead-to-the-city-zero-solution/) |
| --- |
{{< notice tip >}}
