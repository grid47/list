...
---
{{< youtube KFYvX7u-Hs8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2477: Minimum Fuel Cost to Report to the Capital](https://grid47.xyz/posts/leetcode-2476-closest-nodes-queries-in-a-binary-search-tree-solution/) |
| --- |
{{< notice info >}}
