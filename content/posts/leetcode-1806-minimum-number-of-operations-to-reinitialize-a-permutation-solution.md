...
---
{{< youtube MT7Qo0LmoFo >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1807: Evaluate the Bracket Pairs of a String](https://grid47.xyz/posts/leetcode-1806-minimum-number-of-operations-to-reinitialize-a-permutation-solution/) |
| --- |
{{< notice info >}}
