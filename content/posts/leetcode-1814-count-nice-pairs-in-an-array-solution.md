...
---
{{< youtube qUNprFiUKyw >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1816: Truncate Sentence](https://grid47.xyz/posts/leetcode-1814-count-nice-pairs-in-an-array-solution/) |
| --- |
{{< notice info >}}
