...
---
{{< youtube aMJ3T0K8LjI >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2717: Semi-Ordered Permutation](https://grid47.xyz/posts/leetcode-2716-minimize-string-length-solution/) |
| --- |
{{< notice info >}}
