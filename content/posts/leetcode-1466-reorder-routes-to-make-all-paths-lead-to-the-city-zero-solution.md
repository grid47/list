...
---
{{< youtube qL4UaMAdPts >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1471: The k Strongest Values in an Array](https://grid47.xyz/posts/leetcode-1471-the-k-strongest-values-in-an-array-solution/) |
| --- |
{{< notice info >}}
