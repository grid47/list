...
---
{{< youtube jNPKX6McyCg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2918: Minimum Equal Sum of Two Arrays After Replacing Zeros](https://grid47.xyz/posts/leetcode-2918-minimum-equal-sum-of-two-arrays-after-replacing-zeros-solution/) |
| --- |
{{< notice tip >}}
