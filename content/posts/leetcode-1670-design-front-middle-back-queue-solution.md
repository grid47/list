...
---
{{< youtube HSOiUhfXUTg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1671: Minimum Number of Removals to Make Mountain Array](https://grid47.xyz/posts/leetcode-1671-minimum-number-of-removals-to-make-mountain-array-solution/) |
| --- |
{{< notice tip >}}
