...
---
{{< youtube HqSBI1RVM8c >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2525: Categorize Box According to Criteria](https://grid47.xyz/posts/leetcode-2525-categorize-box-according-to-criteria-solution/) |
| --- |
{{< notice tip >}}
