...
---
{{< youtube oZFY64vwfXI >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2550: Count Collisions of Monkeys on a Polygon](https://grid47.xyz/posts/leetcode-2549-count-distinct-numbers-on-board-solution/) |
| --- |
{{< notice info >}}
