...
---
{{< youtube 318hrWVr_5U >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1752: Check if Array Is Sorted and Rotated](https://grid47.xyz/posts/leetcode-1752-check-if-array-is-sorted-and-rotated-solution/) |
| --- |
{{< notice tip >}}
