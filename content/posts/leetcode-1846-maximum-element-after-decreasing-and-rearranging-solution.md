...
---
{{< youtube o_hVl8IXuIE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1848: Minimum Distance to the Target Element](https://grid47.xyz/posts/leetcode-1848-minimum-distance-to-the-target-element-solution/) |
| --- |
{{< notice tip >}}
