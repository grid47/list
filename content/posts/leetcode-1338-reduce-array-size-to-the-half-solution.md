...
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1339: Maximum Product of Splitted Binary Tree](https://grid47.xyz/posts/leetcode-1338-reduce-array-size-to-the-half-solution/) |
| --- |
{{< notice info >}}
