...
---
{{< youtube kPsDTGcrzGM >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1519: Number of Nodes in the Sub-Tree With the Same Label](https://grid47.xyz/posts/leetcode-1519-number-of-nodes-in-the-sub-tree-with-the-same-label-solution/) |
| --- |
{{< notice tip >}}
