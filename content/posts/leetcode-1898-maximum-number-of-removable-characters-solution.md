...
---
{{< youtube NMP3nRPyX5g >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1899: Merge Triplets to Form Target Triplet](https://grid47.xyz/posts/leetcode-1899-merge-triplets-to-form-target-triplet-solution/) |
| --- |
{{< notice tip >}}
