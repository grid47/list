...
---
{{< youtube cueOpK5QMEA >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2492: Minimum Score of a Path Between Two Cities](https://grid47.xyz/posts/leetcode-2492-minimum-score-of-a-path-between-two-cities-solution/) |
| --- |
{{< notice tip >}}
