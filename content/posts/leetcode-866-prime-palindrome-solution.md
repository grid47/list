...
---
{{< youtube MZSbndVpxH8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #867: Transpose Matrix](https://grid47.xyz/posts/leetcode-866-prime-palindrome-solution/) |
| --- |
{{< notice info >}}
