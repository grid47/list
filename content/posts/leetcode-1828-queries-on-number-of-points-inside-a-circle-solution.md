...
---
{{< youtube fU4oOBSsVMg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1829: Maximum XOR for Each Query](https://grid47.xyz/posts/leetcode-1829-maximum-xor-for-each-query-solution/) |
| --- |
{{< notice tip >}}
