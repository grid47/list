...
---
{{< youtube LkSQby_5YMg >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2171: Removing Minimum Number of Magic Beans](https://grid47.xyz/posts/leetcode-2170-minimum-operations-to-make-the-array-alternating-solution/) |
| --- |
{{< notice info >}}
