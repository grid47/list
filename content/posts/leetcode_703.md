...
tags = ["Tree","Binary Search Tree","Design","Heap","Data Stream"]
categories = [
    "Easy"
]
series = ["Leetcode"]
...
---
{{< youtube hOjcdrqMoQ8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #704: Binary Search](https://grid47.xyz/posts/leetcode_704) |
| --- |
{{< notice info >}}
