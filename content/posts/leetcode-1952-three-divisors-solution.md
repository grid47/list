...
---
{{< youtube Rl-JOgrVru0 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1957: Delete Characters to Make Fancy String](https://grid47.xyz/posts/leetcode-1957-delete-characters-to-make-fancy-string-solution/) |
| --- |
{{< notice tip >}}
