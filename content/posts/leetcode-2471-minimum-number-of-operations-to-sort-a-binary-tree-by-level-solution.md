...
---
{{< youtube yi_h_UMHD7s >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2475: Number of Unequal Triplets in Array](https://grid47.xyz/posts/leetcode-2471-minimum-number-of-operations-to-sort-a-binary-tree-by-level-solution/) |
| --- |
{{< notice info >}}
