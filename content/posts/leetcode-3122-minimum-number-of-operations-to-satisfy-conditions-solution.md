...
---
{{< youtube LLDe54TfbMs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #3127: Make a Square with the Same Color](https://grid47.xyz/posts/leetcode-3122-minimum-number-of-operations-to-satisfy-conditions-solution/) |
| --- |
{{< notice info >}}
