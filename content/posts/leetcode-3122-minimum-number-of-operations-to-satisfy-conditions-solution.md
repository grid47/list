...
---
{{< youtube LLDe54TfbMs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #3127: Make a Square with the Same Color](https://grid47.xyz/posts/leetcode-3127-make-a-square-with-the-same-color-solution/) |
| --- |
{{< notice info >}}
