...
---
{{< youtube Dxup4m4Krck >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1389: Create Target Array in the Given Order](https://grid47.xyz/posts/leetcode-1389-create-target-array-in-the-given-order-solution/) |
| --- |
{{< notice info >}}
