...
---
{{< youtube 9vAQdmVU2ds >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1759: Count Number of Homogenous Substrings](https://grid47.xyz/posts/leetcode-1758-minimum-changes-to-make-alternating-binary-string-solution/) |
| --- |
{{< notice info >}}
