...
---
{{< youtube wdve85GSjO8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1958: Check if Move is Legal](https://grid47.xyz/posts/leetcode-1958-check-if-move-is-legal-solution/) |
| --- |
{{< notice tip >}}
