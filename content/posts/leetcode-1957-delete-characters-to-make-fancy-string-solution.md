...
---
{{< youtube wdve85GSjO8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1958: Check if Move is Legal](https://grid47.xyz/posts/leetcode-1957-delete-characters-to-make-fancy-string-solution/) |
| --- |
{{< notice info >}}
