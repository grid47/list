...
---
{{< youtube wdve85GSjO8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1958: Check if Move is Legal](https://grid47.xyz/posts/leetcode-1958-check-if-move-is-legal-solution/) |
| --- |
{{< notice info >}}
