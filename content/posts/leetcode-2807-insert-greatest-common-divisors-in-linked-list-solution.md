...
---
{{< youtube SVnSiD95r-0 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2808: Minimum Seconds to Equalize a Circular Array](https://grid47.xyz/posts/leetcode-2808-minimum-seconds-to-equalize-a-circular-array-solution/) |
| --- |
{{< notice tip >}}
