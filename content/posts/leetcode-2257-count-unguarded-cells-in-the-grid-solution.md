...
---
{{< youtube V4jbxAhIHJw >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2259: Remove Digit From Number to Maximize Result](https://grid47.xyz/posts/leetcode-2259-remove-digit-from-number-to-maximize-result-solution/) |
| --- |
{{< notice tip >}}
