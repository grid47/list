...
---
{{< youtube lRCaNiqO3xI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1986: Minimum Number of Work Sessions to Finish the Tasks](https://grid47.xyz/posts/leetcode-1986-minimum-number-of-work-sessions-to-finish-the-tasks-solution/) |
| --- |
{{< notice tip >}}
