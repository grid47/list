...
---
{{< youtube rKnD7rLT0lI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #116: Populating Next Right Pointers in Each Node](https://grid47.xyz/posts/leetcode-116-populating-next-right-pointers-in-each-node-solution/) |
| --- |
{{< notice tip >}}
