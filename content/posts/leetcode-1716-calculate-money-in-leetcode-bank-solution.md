...
---
{{< youtube tKK7gvPCQfs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1717: Maximum Score From Removing Substrings](https://grid47.xyz/posts/leetcode-1717-maximum-score-from-removing-substrings-solution/) |
| --- |
{{< notice tip >}}
