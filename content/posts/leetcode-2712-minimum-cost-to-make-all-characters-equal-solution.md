...
---
{{< youtube 8MHnlNroHaU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2716: Minimize String Length](https://grid47.xyz/posts/leetcode-2716-minimize-string-length-solution/) |
| --- |
{{< notice tip >}}
