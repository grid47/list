...
{{< rmtimg 
    src="https://raw.githubusercontent.com/grid47/list-images/refs/heads/main/list/51.jpeg" 
    alt="Queens placed delicately on a glowing chessboard, forming an elegant arrangement."
    caption="Solution to LeetCode 51: N-Queens Problem"
    width="900px"
    borderRadius="8px"
    align="center" 
    captionColor="#555"
...
---
{{< youtube Ph95IHmRp5M >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #53: Maximum Subarray](https://grid47.xyz/posts/leetcode-53-maximum-subarray-solution/) |
| --- |
{{< notice info >}}
