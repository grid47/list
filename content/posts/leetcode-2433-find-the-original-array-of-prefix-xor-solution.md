...
---
{{< youtube idcT-p_DDrI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2434: Using a Robot to Print the Lexicographically Smallest String](https://grid47.xyz/posts/leetcode-2434-using-a-robot-to-print-the-lexicographically-smallest-string-solution/) |
| --- |
{{< notice tip >}}
