...
---
{{< youtube xWRu1KHVAIo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2501: Longest Square Streak in an Array](https://grid47.xyz/posts/leetcode-2501-longest-square-streak-in-an-array-solution/) |
| --- |
{{< notice tip >}}
