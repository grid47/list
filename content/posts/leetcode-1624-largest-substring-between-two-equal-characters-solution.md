...
---
{{< youtube rfjeFs3JuYM >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1625: Lexicographically Smallest String After Applying Operations](https://grid47.xyz/posts/leetcode-1625-lexicographically-smallest-string-after-applying-operations-solution/) |
| --- |
{{< notice tip >}}
