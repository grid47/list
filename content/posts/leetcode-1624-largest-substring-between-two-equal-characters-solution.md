...
---
{{< youtube rfjeFs3JuYM >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1625: Lexicographically Smallest String After Applying Operations](https://grid47.xyz/posts/leetcode-1624-largest-substring-between-two-equal-characters-solution/) |
| --- |
{{< notice info >}}
