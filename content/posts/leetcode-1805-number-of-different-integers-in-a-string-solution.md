...
---
{{< youtube 1vZ2c92YgOc >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1806: Minimum Number of Operations to Reinitialize a Permutation](https://grid47.xyz/posts/leetcode-1806-minimum-number-of-operations-to-reinitialize-a-permutation-solution/) |
| --- |
{{< notice tip >}}
