...
---
{{< youtube EkoNpVUBSVo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2283: Check if Number Has Equal Digit Count and Digit Value](https://grid47.xyz/posts/leetcode-2283-check-if-number-has-equal-digit-count-and-digit-value-solution/) |
| --- |
{{< notice tip >}}
