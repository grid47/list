...
---
{{< youtube Lyesi93Z6_A >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2245: Maximum Trailing Zeros in a Cornered Path](https://grid47.xyz/posts/leetcode-2245-maximum-trailing-zeros-in-a-cornered-path-solution/) |
| --- |
{{< notice tip >}}
