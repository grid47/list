...
---
{{< youtube h7FESSswnR8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2740: Find the Value of the Partition](https://grid47.xyz/posts/leetcode-2740-find-the-value-of-the-partition-solution/) |
| --- |
{{< notice tip >}}
