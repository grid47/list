...
{{< rmtimg 
    src="https://raw.githubusercontent.com/grid47/list-images/refs/heads/main/list/87.jpeg" 
    alt="A glowing string of letters gently rearranging itself into a new pattern."
    caption="Solution to LeetCode 87: Scramble String Problem"
    width="900px"
    borderRadius="8px"
    align="center" 
    captionColor="#555"
...
---
{{< youtube 0ugQof_dTOU >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #89: Gray Code](https://grid47.xyz/posts/leetcode-87-scramble-string-solution/) |
| --- |
{{< notice info >}}
