...
---
{{< youtube __h7BgcH_Cs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2855: Minimum Right Shifts to Sort the Array](https://grid47.xyz/posts/leetcode-2855-minimum-right-shifts-to-sort-the-array-solution/) |
| --- |
{{< notice tip >}}
