...
---
{{< youtube iZkBnYIJ9Qc >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2824: Count Pairs Whose Sum is Less than Target](https://grid47.xyz/posts/leetcode-2824-count-pairs-whose-sum-is-less-than-target-solution/) |
| --- |
{{< notice tip >}}
