...
---
{{< youtube lLAvgl2voc4 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1963: Minimum Number of Swaps to Make the String Balanced](https://grid47.xyz/posts/leetcode-1963-minimum-number-of-swaps-to-make-the-string-balanced-solution/) |
| --- |
{{< notice tip >}}
