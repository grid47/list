...
---
{{< youtube Ikp8SgbgbEo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2357: Make Array Zero by Subtracting Equal Amounts](https://grid47.xyz/posts/leetcode-2357-make-array-zero-by-subtracting-equal-amounts-solution/) |
| --- |
{{< notice tip >}}
