...
---
{{< youtube _nyH2TA95yY >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2610: Convert an Array Into a 2D Array With Conditions](https://grid47.xyz/posts/leetcode-2610-convert-an-array-into-a-2d-array-with-conditions-solution/) |
| --- |
{{< notice tip >}}
