...
---
{{< youtube UddDgt52h9g >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2059: Minimum Operations to Convert Number](https://grid47.xyz/posts/leetcode-2059-minimum-operations-to-convert-number-solution/) |
| --- |
{{< notice tip >}}
