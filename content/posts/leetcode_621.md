...
tags = ["Array","Greedy","Queue","Counting"]
categories = [
    "Medium"
]
series = ["Leetcode"]
...
---
{{< youtube s8p8ukTyA2I >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #622: Design Circular Queue](https://grid47.xyz/posts/leetcode_622) |
| --- |
{{< notice info >}}
