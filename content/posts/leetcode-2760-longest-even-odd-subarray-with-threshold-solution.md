...
---
{{< youtube _XNaJUXSh04 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2761: Prime Pairs With Target Sum](https://grid47.xyz/posts/leetcode-2761-prime-pairs-with-target-sum-solution/) |
| --- |
{{< notice tip >}}
