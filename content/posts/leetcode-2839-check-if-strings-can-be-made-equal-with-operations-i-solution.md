...
---
{{< youtube b46PWRWHFp4 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2840: Check if Strings Can be Made Equal With Operations II](https://grid47.xyz/posts/leetcode-2840-check-if-strings-can-be-made-equal-with-operations-ii-solution/) |
| --- |
{{< notice tip >}}
