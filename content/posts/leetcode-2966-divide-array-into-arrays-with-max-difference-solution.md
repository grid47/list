...
---
{{< youtube XleOio1oJeo >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2971: Find Polygon With the Largest Perimeter](https://grid47.xyz/posts/leetcode-2966-divide-array-into-arrays-with-max-difference-solution/) |
| --- |
{{< notice info >}}
