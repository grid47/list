...
---
{{< youtube v1HpZUnQ4Yo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1876: Substrings of Size Three with Distinct Characters](https://grid47.xyz/posts/leetcode-1876-substrings-of-size-three-with-distinct-characters-solution/) |
| --- |
{{< notice tip >}}
