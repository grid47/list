...
---
{{< youtube NztQwlNn1XA >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2600: K Items With the Maximum Sum](https://grid47.xyz/posts/leetcode-2600-k-items-with-the-maximum-sum-solution/) |
| --- |
{{< notice tip >}}
