...
---
{{< youtube NztQwlNn1XA >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2600: K Items With the Maximum Sum](https://grid47.xyz/posts/leetcode-2600-k-items-with-the-maximum-sum-solution/) |
| --- |
{{< notice info >}}
