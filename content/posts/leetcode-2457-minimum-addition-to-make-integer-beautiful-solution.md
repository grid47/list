...
---
{{< youtube NoGK4582ey8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2460: Apply Operations to an Array](https://grid47.xyz/posts/leetcode-2457-minimum-addition-to-make-integer-beautiful-solution/) |
| --- |
{{< notice info >}}
