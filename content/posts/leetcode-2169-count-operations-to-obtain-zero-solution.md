...
---
{{< youtube yPqe3KshvVo >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2170: Minimum Operations to Make the Array Alternating](https://grid47.xyz/posts/leetcode-2169-count-operations-to-obtain-zero-solution/) |
| --- |
{{< notice info >}}
