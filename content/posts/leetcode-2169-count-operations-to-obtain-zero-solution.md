...
---
{{< youtube yPqe3KshvVo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2170: Minimum Operations to Make the Array Alternating](https://grid47.xyz/posts/leetcode-2170-minimum-operations-to-make-the-array-alternating-solution/) |
| --- |
{{< notice tip >}}
