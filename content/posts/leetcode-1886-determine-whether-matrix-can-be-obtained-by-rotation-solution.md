...
---
{{< youtube vf_nUx64R0E >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1887: Reduction Operations to Make the Array Elements Equal](https://grid47.xyz/posts/leetcode-1887-reduction-operations-to-make-the-array-elements-equal-solution/) |
| --- |
{{< notice tip >}}
