...
---
{{< youtube H8_hAPOW5UE >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1434: Number of Ways to Wear Different Hats to Each Other](https://grid47.xyz/posts/leetcode-1433-check-if-a-string-can-break-another-string-solution/) |
| --- |
{{< notice info >}}
