...
---
{{< youtube bRjEkQZ1R7Y >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1743: Restore the Array From Adjacent Pairs](https://grid47.xyz/posts/leetcode-1743-restore-the-array-from-adjacent-pairs-solution/) |
| --- |
{{< notice tip >}}
