...
---
{{< youtube QBLw9bVFIDQ >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2875: Minimum Size Subarray in Infinite Array](https://grid47.xyz/posts/leetcode-2875-minimum-size-subarray-in-infinite-array-solution/) |
| --- |
