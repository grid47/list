...
---
{{< youtube _Zt6ADHF8nE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2946: Matrix Similarity After Cyclic Shifts](https://grid47.xyz/posts/leetcode-2946-matrix-similarity-after-cyclic-shifts-solution/) |
| --- |
{{< notice tip >}}
