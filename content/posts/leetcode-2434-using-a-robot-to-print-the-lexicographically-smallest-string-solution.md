...
---
{{< youtube -8gRuQFSuX8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2435: Paths in Matrix Whose Sum Is Divisible by K](https://grid47.xyz/posts/leetcode-2435-paths-in-matrix-whose-sum-is-divisible-by-k-solution/) |
| --- |
{{< notice tip >}}
