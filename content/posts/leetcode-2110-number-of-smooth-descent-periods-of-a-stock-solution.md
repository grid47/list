...
---
{{< youtube p_hKOwJ7azU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2116: Check if a Parentheses String Can Be Valid](https://grid47.xyz/posts/leetcode-2116-check-if-a-parentheses-string-can-be-valid-solution/) |
| --- |
{{< notice tip >}}
