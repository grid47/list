...
---
{{< youtube p_hKOwJ7azU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2111: Minimum Operations to Make the Array K-Increasing](https://grid47.xyz/posts/leetcode-2111-minimum-operations-to-make-the-array-k-increasing-solution/) |
| --- |
{{< notice tip >}}
