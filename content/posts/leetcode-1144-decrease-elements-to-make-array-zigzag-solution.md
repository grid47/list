...
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1145: Binary Tree Coloring Game](https://grid47.xyz/posts/leetcode-1144-decrease-elements-to-make-array-zigzag-solution/) |
| --- |
{{< notice info >}}
