...
---
{{< youtube FqAoYAwbwV8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1326: Minimum Number of Taps to Open to Water a Garden](https://grid47.xyz/posts/leetcode-1326-minimum-number-of-taps-to-open-to-water-a-garden-solution/) |
| --- |
{{< notice tip >}}
