...
---
{{< youtube FqAoYAwbwV8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1326: Minimum Number of Taps to Open to Water a Garden](https://grid47.xyz/posts/leetcode-1325-delete-leaves-with-a-given-value-solution/) |
| --- |
{{< notice info >}}
