...
---
{{< youtube J6D5xPSlGHY >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2068: Check Whether Two Strings are Almost Equivalent](https://grid47.xyz/posts/leetcode-2068-check-whether-two-strings-are-almost-equivalent-solution/) |
| --- |
{{< notice tip >}}
