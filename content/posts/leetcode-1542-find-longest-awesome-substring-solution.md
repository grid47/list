...
---
{{< youtube 0-HJwJLayps >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1545: Find Kth Bit in Nth Binary String](https://grid47.xyz/posts/leetcode-1545-find-kth-bit-in-nth-binary-string-solution/) |
| --- |
{{< notice info >}}
