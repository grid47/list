...
---
{{< youtube 8NPbAvVXKR4 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2102: Sequentially Ordinal Rank Tracker](https://grid47.xyz/posts/leetcode-2102-sequentially-ordinal-rank-tracker-solution/) |
| --- |
{{< notice tip >}}
