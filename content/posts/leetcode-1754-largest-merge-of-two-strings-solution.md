...
---
{{< youtube YB-A6OUj98o >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1758: Minimum Changes To Make Alternating Binary String](https://grid47.xyz/posts/leetcode-1758-minimum-changes-to-make-alternating-binary-string-solution/) |
| --- |
{{< notice tip >}}
