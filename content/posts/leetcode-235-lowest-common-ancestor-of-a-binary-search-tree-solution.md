...
---
{{< youtube ML6vGnziUaI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #236: Lowest Common Ancestor of a Binary Tree](https://grid47.xyz/posts/leetcode-236-lowest-common-ancestor-of-a-binary-tree-solution/) |
| --- |
{{< notice tip >}}
