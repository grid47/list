...
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1302: Deepest Leaves Sum](https://grid47.xyz/posts/leetcode-1302-deepest-leaves-sum-solution/) |
| --- |
{{< notice tip >}}
