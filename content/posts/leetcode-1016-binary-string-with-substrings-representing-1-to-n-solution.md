...
---
{{< youtube EAHOzX67VB8 >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1017: Convert to Base -2](https://grid47.xyz/posts/leetcode-1016-binary-string-with-substrings-representing-1-to-n-solution/) |
| --- |
{{< notice info >}}
