...
---
{{< youtube EAHOzX67VB8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1017: Convert to Base -2](https://grid47.xyz/posts/leetcode-1017-convert-to-base-2-solution/) |
| --- |
{{< notice tip >}}
