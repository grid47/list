...
---
{{< youtube MNykgz1_ONQ >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1144: Decrease Elements To Make Array Zigzag](https://grid47.xyz/posts/leetcode-1144-decrease-elements-to-make-array-zigzag-solution/) |
| --- |
