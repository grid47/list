...
---
{{< youtube oFuFTMu2Tgg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1769: Minimum Number of Operations to Move All Balls to Each Box](https://grid47.xyz/posts/leetcode-1769-minimum-number-of-operations-to-move-all-balls-to-each-box-solution/) |
| --- |
{{< notice tip >}}
