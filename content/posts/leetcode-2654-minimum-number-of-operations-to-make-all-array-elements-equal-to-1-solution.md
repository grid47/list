...
---
{{< youtube 9LOYxdctbs0 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #2656: Maximum Sum With Exactly K Elements ](https://grid47.xyz/posts/leetcode-2656-maximum-sum-with-exactly-k-elements-solution/) |
| --- |
{{< notice tip >}}
