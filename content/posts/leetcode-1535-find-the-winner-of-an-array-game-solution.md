...
---
{{< youtube v6On1TQfMTU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1536: Minimum Swaps to Arrange a Binary Grid](https://grid47.xyz/posts/leetcode-1536-minimum-swaps-to-arrange-a-binary-grid-solution/) |
| --- |
{{< notice tip >}}
