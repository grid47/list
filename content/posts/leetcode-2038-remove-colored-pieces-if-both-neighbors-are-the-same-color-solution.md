...
---
{{< youtube 03zIcb12PKo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2039: The Time When the Network Becomes Idle](https://grid47.xyz/posts/leetcode-2039-the-time-when-the-network-becomes-idle-solution/) |
| --- |
