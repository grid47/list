...
---
{{< youtube 03zIcb12PKo >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2039: The Time When the Network Becomes Idle](https://grid47.xyz/posts/leetcode-2039-the-time-when-the-network-becomes-idle-solution/) |
| --- |
{{< notice info >}}
