...
---
{{< youtube bH2EmMR5jpU >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2767: Partition String Into Minimum Beautiful Substrings](https://grid47.xyz/posts/leetcode-2767-partition-string-into-minimum-beautiful-substrings-solution/) |
| --- |
{{< notice info >}}
