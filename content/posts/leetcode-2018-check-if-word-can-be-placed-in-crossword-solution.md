...
---
{{< youtube l28OqpotdbU >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2019: The Score of Students Solving Math Expression](https://grid47.xyz/posts/leetcode-2018-check-if-word-can-be-placed-in-crossword-solution/) |
| --- |
{{< notice info >}}
