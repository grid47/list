...
---
{{< youtube ksN__viaDFs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1857: Largest Color Value in a Directed Graph](https://grid47.xyz/posts/leetcode-1855-maximum-distance-between-a-pair-of-values-solution/) |
| --- |
{{< notice info >}}
