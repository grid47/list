...
---
{{< youtube ksN__viaDFs >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #1857: Largest Color Value in a Directed Graph](https://grid47.xyz/posts/leetcode-1857-largest-color-value-in-a-directed-graph-solution/) |
| --- |
{{< notice info >}}
