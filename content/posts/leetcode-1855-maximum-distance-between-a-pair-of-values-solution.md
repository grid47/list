...
---
{{< youtube ksN__viaDFs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / Next : [LeetCode #1857: Largest Color Value in a Directed Graph](https://grid47.xyz/posts/leetcode-1857-largest-color-value-in-a-directed-graph-solution/) |
| --- |
{{< notice tip >}}
