...
---
{{< youtube AZA8orksO4w >}}
| [LeetCode Exercise Compilation](https://grid47.xyz/leetcode/) / Next : [LeetCode #2360: Longest Cycle in a Graph](https://grid47.xyz/posts/leetcode-2359-find-closest-node-to-given-two-nodes-solution/) |
| --- |
{{< notice info >}}
