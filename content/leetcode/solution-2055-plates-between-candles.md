...
---
{{< youtube -1IsQyTM6Lg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2058: Find the Minimum and Maximum Number of Nodes Between Critical Points](https://grid47.xyz/leetcode/solution-2058-find-the-minimum-and-maximum-number-of-nodes-between-critical-points/) |
| --- |
