...
---
{{< youtube Aqhrp1nYMqo >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2645: Minimum Additions to Make Valid String](https://grid47.xyz/leetcode/solution-2645-minimum-additions-to-make-valid-string/) |
| --- |
