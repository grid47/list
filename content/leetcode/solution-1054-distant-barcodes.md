...
---
{{< youtube MlgCCJ7MfKQ >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1061: Lexicographically Smallest Equivalent String](https://grid47.xyz/leetcode/solution-1061-lexicographically-smallest-equivalent-string/) |
| --- |
