...
---
{{< youtube XD2LVEXo8j8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2839: Check if Strings Can be Made Equal With Operations I](https://grid47.xyz/leetcode/solution-2839-check-if-strings-can-be-made-equal-with-operations-i/) |
| --- |
