...
---
{{< youtube K-IoQp07D8c >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2222: Number of Ways to Select Buildings](https://grid47.xyz/leetcode/solution-2222-number-of-ways-to-select-buildings/) |
| --- |
