...
---
{{< youtube u4bKt4MBHUU >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2718: Sum of Matrix After Queries](https://grid47.xyz/leetcode/solution-2718-sum-of-matrix-after-queries/) |
| --- |
