...
---
{{< youtube RrnhHjJmzj8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1283: Find the Smallest Divisor Given a Threshold](https://grid47.xyz/leetcode/solution-1283-find-the-smallest-divisor-given-a-threshold/) |
| --- |
