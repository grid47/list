...
---
{{< youtube DDQR_mDTTFI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2684: Maximum Number of Moves in a Grid](https://grid47.xyz/leetcode/solution-2684-maximum-number-of-moves-in-a-grid/) |
| --- |
