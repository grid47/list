...
---
{{< youtube gRHnWbKiUIE >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #237: Delete Node in a Linked List](https://grid47.xyz/leetcode/solution-237-delete-node-in-a-linked-list/) |
| --- |
