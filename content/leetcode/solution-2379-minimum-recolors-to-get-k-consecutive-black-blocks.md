...
---
{{< youtube RRmSKRsT9tg >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2380: Time Needed to Rearrange a Binary String](https://grid47.xyz/leetcode/solution-2380-time-needed-to-rearrange-a-binary-string/) |
| --- |
