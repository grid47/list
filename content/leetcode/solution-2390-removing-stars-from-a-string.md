...
---
{{< youtube Qln1aXh2kvQ >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2391: Minimum Amount of Time to Collect Garbage](https://grid47.xyz/leetcode/solution-2391-minimum-amount-of-time-to-collect-garbage/) |
| --- |
