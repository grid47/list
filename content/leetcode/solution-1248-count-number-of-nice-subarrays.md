...
---
{{< youtube 4zNK0rhFfcA >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1249: Minimum Remove to Make Valid Parentheses](https://grid47.xyz/leetcode/solution-1249-minimum-remove-to-make-valid-parentheses/) |
| --- |
