...
---
{{< youtube HKc9PcSzNic >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #2522: Partition String Into Substrings With Values at Most K](https://grid47.xyz/leetcode/solution-2522-partition-string-into-substrings-with-values-at-most-k/) |
| --- |
