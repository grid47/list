...
---
{{< youtube ML6vGnziUaI >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #236: Lowest Common Ancestor of a Binary Tree](https://grid47.xyz/leetcode/solution-236-lowest-common-ancestor-of-a-binary-tree/) |
| --- |
