...
---
{{< youtube ZH8TeWFYpx8 >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1261: Find Elements in a Contaminated Binary Tree](https://grid47.xyz/leetcode/solution-1261-find-elements-in-a-contaminated-binary-tree/) |
| --- |
