...
---
{{< youtube tKK7gvPCQfs >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1717: Maximum Score From Removing Substrings](https://grid47.xyz/leetcode/solution-1717-maximum-score-from-removing-substrings/) |
| --- |
