...
---
{{< youtube IG6X2CXMdKw >}}
| [LeetCode Solutions Library](https://grid47.xyz/leetcode/) / [DSA Sheets](https://grid47.xyz/sheets/) / [Course Catalog](https://grid47.xyz/courses/) / Next : [LeetCode #1798: Maximum Number of Consecutive Values You Can Make](https://grid47.xyz/leetcode/solution-1798-maximum-number-of-consecutive-values-you-can-make/) |
| --- |
